...
This is early work. The server reports diagnostics (syntax and type errors, warnings), shows documentation or the type of the expression under the cursor on hover, and completes names in scope and methods after `.`, including in scripts that do not parse.
